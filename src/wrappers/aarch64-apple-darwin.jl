# Autogenerated wrapper script for Librsvg_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(librsvg, "@rpath/librsvg-2.2.dylib")
JLLWrappers.@declare_executable_product(rsvg_convert)
function __init__()
    JLLWrappers.@generate_init_header(gdk_pixbuf_jll, Pango_jll, Cairo_jll, FreeType2_jll, Glib_jll, XML2_jll)
