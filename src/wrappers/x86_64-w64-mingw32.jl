...
const libpixbufloader_svg_splitpath = ["lib", "gdk-pixbuf-2.0", "2.10.0", "loaders", "libpixbufloader-svg.dll"]
...
const librsvg_splitpath = ["bin", "librsvg-2-2.dll"]
...
const librsvg = "librsvg-2-2.dll"


# Relative path to `rsvg_convert`
const rsvg_convert_splitpath = ["bin", "rsvg-convert.exe"]
