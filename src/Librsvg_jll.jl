...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Librsvg_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("925c91fb-5dd6-59dd-8e8c-345e74382d89"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Librsvg", artifacts_toml) for e in artifacts["Librsvg"]]
...
if best_platform === nothing
    @debug("Unable to load Librsvg; unsupported platform $(triplet(platform_key_abi()))")
else
